...
class ArtikelAdapter(private val listArtikel: ArrayList<Artikel>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.imgArtikel.setOnClickListener {
            ...
            intent.putExtra(DetailArticleActivity.DATA_DESC, listArtikel[position].titleArtikel)
            intent.putExtra(DetailArticleActivity.DATA_IMAGE, listArtikel[position].titleArtikel)
